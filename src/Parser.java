...
//	static Hashtable<String, String> memory1 = new Hashtable<String, String>();
//	static Hashtable<String, String> memory2 = new Hashtable<String, String>();
//	static Hashtable<String, String> memory3 = new Hashtable<String, String>();
...
//	static ArrayList<String> process1 = new ArrayList<String>();
//	static ArrayList<String> process2 = new ArrayList<String>();
//	static ArrayList<String> process3 = new ArrayList<String>();
//
//	static int PC1 = 0;
//	static int PC2 = 0;
//	static int PC3 = 0;
...
//		}
	...
	public static int ifSpace(String[] mem) {
		if (mem[0].equals("")) {
			return 0;
		} else if (mem[21]==null || mem[21].equals("")) {
			return 20;
		} else
			return -1;
	}
	...
	public static void SwapDiskToMem() throws IOException {
		...
		if (space == 0) {
			...
			memory[23] = "20";
			memory[24] = "39";
			System.out.println("The process that is swapped from disk to memory is " + memory[20]);
		} else {
